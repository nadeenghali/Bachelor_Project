...
dataset = pd.read_csv('40RepRegistered.csv')
...
datasettst = pd.read_csv('40RepSignIns.csv')
X_test = datasettst.iloc[:, 0:55].values
y_test = datasettst.iloc[:, 55].values

datasettstatt = pd.read_csv('40RepSignInsAtt.csv')
