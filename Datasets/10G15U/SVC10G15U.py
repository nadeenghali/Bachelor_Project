...
dataset = pd.read_csv('10G15URegistered.csv')
...
datasettst = pd.read_csv('10G15USignIns.csv')
X_test = datasettst.iloc[:, 0:55].values
y_test = datasettst.iloc[:, 55].values

datasettstatt = pd.read_csv('10G15USignInsAtt.csv')
...
print("FAR: \n")
print("{:.3f}".format(FA*100.0/21))
print("FRR: \n")
print("{:.3f}".format(FR*100.0/45))
